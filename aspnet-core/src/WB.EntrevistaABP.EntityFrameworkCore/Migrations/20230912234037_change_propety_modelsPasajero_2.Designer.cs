...
{
    [DbContext(typeof(EntrevistaABPDbContext))]
    [Migration("20230912234037_change_propety_modelsPasajero_2")]
    partial class changepropetymodelsPasajero2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Pasajeros.Pasajero", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPasajeros", (string)null);
                });

            modelBuilder.Entity("WB.EntrevistaABP.Reservas.Reserva", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReservas", (string)null);
                });

            modelBuilder.Entity("WB.EntrevistaABP.Viajes.Viaje", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime>("Fecha_de_salida")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<List<Guid>>("ListaUsuarios")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.ToTable("AppViajes", (string)null);
                });
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Pasajeros.Pasajero", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("WB.EntrevistaABP.Pasajeros.Pasajero", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Reservas.Reserva", b =>
                {
                    b.HasOne("WB.EntrevistaABP.Pasajeros.Pasajero", "Pasajero")
                        .WithMany("Reservas")
                        .HasForeignKey("PasajeroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WB.EntrevistaABP.Viajes.Viaje", "Viaje")
                        .WithMany("Reservas")
