...
namespace WB.EntrevistaABP.Migrations
{
    ...
    [Migration("20230908204210_newChange_addDescriminator_Pasajeros")]
    partial class newChangeaddDescriminatorPasajeros
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Pasajeros.Pasajero", b =>
                {
                    b.HasOne("ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("WB.EntrevistaABP.Pasajeros.Pasajero", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
